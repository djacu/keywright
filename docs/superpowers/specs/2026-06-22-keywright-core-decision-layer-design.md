...
**Status:** Draft for review (rev 8 — clock-floor is a stable maintained constant in the baked compliance/clock data, decoupled from the flake; rev 7 hardened clock-trust + plumbed validated `now`; adds compliance-data freshness; folds in four rounds of adversarial review + the deployment decision)
**Date:** 2026-06-22
