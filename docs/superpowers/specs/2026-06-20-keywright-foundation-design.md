...
- **Admin-PIN custody (policy):** default corporate posture — the **security team retains the Admin PIN** (escrowed); the **user holds the User PIN**; optional **Reset Code** for self-unblock.
